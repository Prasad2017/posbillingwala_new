...
class AppStrings {
  ...
  String get changePin => tr('ui_change_app_login_pbpin_αñàαñüαñ¬αñÜ_αñ¬αñ¿_αñƒαñòαñ¼αñªαñ▓');
  ...
  String get deleteAllInvoice => tr('ui_delete_all_invoice_αñ╕αñ░αÑìαñ╡_αñ¼αñ▓αÑç_αñ╣αñƒαñ╡').replaceAll('\n', ' ');
  ...
  String get editCustomerDiscountPayment => tr('app_edit_customer_discount_payment');
  ...
  String get noCategoriesFound => tr('ui_no_category_found_please_add_new_categor');
