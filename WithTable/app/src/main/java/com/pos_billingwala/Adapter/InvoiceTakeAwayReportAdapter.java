...
public class InvoiceTakeAwayReportAdapter extends RecyclerView.Adapter<InvoiceTakeAwayReportAdapter.MyViewHolder> {

    Context context;
    List<InvoiceResponse> invoiceResponseList;


    public InvoiceTakeAwayReportAdapter(Context context, List<InvoiceResponse> invoiceResponseList) {
