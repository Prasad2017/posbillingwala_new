...
import com.pos_billingwala.databinding.PrinterInvoiceProductListBinding;

import java.util.List;
import java.util.Locale;


public class PrinterInvoiceAdapter extends RecyclerView.Adapter<PrinterInvoiceAdapter.MyViewHolder> {

    Context context;
    List<ProductCartResponse> productCartResponseList;

    public PrinterInvoiceAdapter(Context context, List<ProductCartResponse> productCartResponseList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(PrinterInvoiceProductListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (!productCartResponse.getProductCGST().isEmpty()) {
            totalCGST += Float.parseFloat(productCartResponse.getProductCGST());
        }
        if (!productCartResponse.getProductSGST().isEmpty()) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public final PrinterInvoiceProductListBinding binding;

        public MyViewHolder(PrinterInvoiceProductListBinding binding) {
