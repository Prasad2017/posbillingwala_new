...
public class MonthPickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public MonthPickerDialog(Context context,
        ...
        setView(view);
        _monthPicker = view.findViewById(R.id.monthPicker);
    ...
    public void setActivatedYear(int activatedMonth) {
    ...
    public static class Builder {
        ...
        public final OnDateSetListener _callBack;
        public int _activatedMonth, _activatedYear;
        public int _minMonth = Calendar.JANUARY, _maxMonth = Calendar.DECEMBER;
        public int _minYear, _maxYear;
        public boolean monthOnly, yearOnly;
        public String title = null;
        public MonthPickerDialog monthPickerDialog;
        public OnYearChangedListener _onYearChanged;
        public OnMonthChangedListener _onMonthChanged;
