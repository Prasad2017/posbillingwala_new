package com.pos_billingwala.CalenderView;
...
public class MonthView extends ListView {
    ...
    public static final int DEFAULT_NUM_DAYS = 4;
    ...
    // days to display
    public final int _numDays = DEFAULT_NUM_DAYS;
    // month
    public final String[] _monthNames;
    public final int _monthTextSize;
    public final int _monthHeaderSize;
    public final int _monthSelectedCircleSize;
    public final int _rowHeightKey;
    public int _numCells = _numDays;
    public int _numRows = DEFAULT_NUM_ROWS;
    // layout padding
    public int _padding = 40;
    public int _width;
    public int _rowHeight = DEFAULT_HEIGHT;
    // paints
    ...
    public int _maxMonth, _minMonth;
    public int _selectedMonth = -1;
    // listener
