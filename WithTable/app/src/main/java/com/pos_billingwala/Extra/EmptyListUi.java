...
public final class EmptyListUi {
    ...
    public static void bind(@Nullable ViewBinding emptyBinding, boolean hasData, @StringRes int subtitleRes) {
        bind(emptyBinding != null ? emptyBinding.getRoot() : null, hasData, subtitleRes);
    }

    public static void bind(@Nullable ViewBinding emptyBinding, boolean hasData, CharSequence subtitleText) {
    ...
    public static void bind(@Nullable View emptyRoot, boolean hasData, @StringRes int subtitleRes) {
        ...
        if (subtitle != null) {
            ...
            // Legacy single TextView — show title + subtitle
