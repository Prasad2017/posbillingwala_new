        ...
        ajax:"{{url('products/all')}}?customer_id="+($("#customerFilter").val() || ''),
            ...
            },
            {
                ...
                "mRender": function(data, type, row){
                    ...
                    actions += '<a href="{{url("products/edit")}}/'+row.productId+'" class="btn btn-sm btn-light" title="Edit"><i class="bx bxs-edit"></i></a>';
                    actions += '<a href="{{url("portions/all")}}/'+row.userId+'/'+row.productId+'" class="btn btn-sm btn-light" title="Portions"><i class="bx bx-food-menu"></i></a>';
                    actions += '<a href="{{url("products/delete")}}/'+row.productId+'" class="btn btn-sm btn-light" title="Toggle"><i class="bx bxs-trash"></i></a>';
                    actions += '</div>';
                    return actions;
                },
