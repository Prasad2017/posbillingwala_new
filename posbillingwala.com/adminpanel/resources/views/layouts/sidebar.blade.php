            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="{{url('subcategories/all')}}"><i class="bx bx-right-arrow-alt"></i>Subcategories</a></li>
                        <li><a href="{{url('portion-masters/all')}}"><i class="bx bx-right-arrow-alt"></i>Portion Master</a></li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="{{url('subcategories/all')}}"><i class="bx bx-right-arrow-alt"></i>Subcategory List</a></li>
                        <li><a href="{{url('subcategories/add')}}"><i class="bx bx-right-arrow-alt"></i>Add Subcategory</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                    ...
                    <ul>
                        <li><a href="{{url('portion-masters/all')}}"><i class="bx bx-right-arrow-alt"></i>Portion List</a></li>
                        <li><a href="{{url('portion-masters/add')}}"><i class="bx bx-right-arrow-alt"></i>Add Portion</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
