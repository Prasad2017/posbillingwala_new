...
public class MessMemberEditFragment extends Fragment {
    ...
    private String customerId, licenceId, memberId = "", memberNetworkStatus = "";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (memberId != null && !memberId.isEmpty() && args != null) {
            ...
            if ("working".equalsIgnoreCase(args.getString("memberType", "student"))) {
        ...
        typeGroup.setOnCheckedChangeListener((g, id) -> updateTypeUi());
        updateTypeUi();
    ...
    private void save() {
        ...
        Api.getClient().saveMessMemberManage(
                MainActivity.userId, customerId, licenceId,
                memberId != null ? memberId : "",
                name, mobile, text(memberAltMobile), text(memberAddress),
                type, text(rollNo), text(college), text(studentYear), text(company),
                text(registrationNo), "active",
