...
import com.posbillingwala.dealer.databinding.FragmentDealerProfileBinding;
...
public class DealerProfile extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.update) {
            if (!binding.dealerName.getText().toString().isEmpty() && !binding.dealerNumber.getText().toString().isEmpty() &&
                    !binding.dealerEmail.getText().toString().isEmpty() && !binding.dealerAddress.getText().toString().isEmpty() &&
                    !binding.aadhaarNumber.getText().toString().isEmpty()) {
                updateProfile();
            } else {
    ...
    private void updateProfile() {
        ...
        Call<AllApiResponse> call = Api.getClient().updateDealerProfile(MainActivity.userId, binding.dealerName.getText().toString(), binding.dealerNumber.getText().toString(),
