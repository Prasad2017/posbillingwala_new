...
import com.posbillingwala.admin.Model.CatalogImportError;
import com.posbillingwala.admin.Model.CatalogImportPreviewResponse;
import com.posbillingwala.admin.Model.CatalogImportSummary;
...
public class ProductExport extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (MainActivity.title != null
            ...
            ((MainActivity) activity).setScreenTitle("Product Import / Export");
        }
