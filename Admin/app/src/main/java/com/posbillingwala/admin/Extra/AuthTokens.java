...
/**
 * Persist and validate server-issued admin auth tokens.
 */
public final class AuthTokens {
    ...
    public static String getToken(Context context) {
        ...
        return Common.getSavedUserData(context, "authToken");
    }
    ...
    public static boolean isTokenExpired(Context context) {
        ...
        if (expiresAt == null || expiresAt.trim().isEmpty()) {
            // Legacy tokens without expiry — treat as valid until server rejects.
            return false;
        }
