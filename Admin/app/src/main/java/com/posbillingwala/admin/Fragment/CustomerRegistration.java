...
public class CustomerRegistration extends Fragment {
    ...
    View view;
    @BindViews({R.id.customerName, R.id.customerNumber, R.id.customerAddress, R.id.customerShopName, R.id.amount})
    ...
    private void submitRegistration() {
        ...
        Call<AllApiResponse> call = Api.getClient().customerRegistration(
                textInputEditTexts.get(0).getText().toString(),
                textInputEditTexts.get(1).getText().toString(),
                textInputEditTexts.get(2).getText().toString(),
                textInputEditTexts.get(3).getText().toString(),
                licenseKey,
                licenceValidity,
                licenceType,
                textInputEditTexts.get(4).getText().toString(),
                fastBilling,
                takeAway,
                dineIn);
