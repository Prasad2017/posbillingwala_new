...
import com.posbillingwala.admin.Model.BusinessTemplateResponse;
import com.posbillingwala.admin.R;
import com.posbillingwala.admin.Retrofit.Api;
import com.posbillingwala.admin.databinding.FragmentLicenceBusinessTemplateBinding;
...
/**
 * Admin: set business template for a single licence. POS picks up on Fetch Data.
 */
public class LicenceBusinessTemplate extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) activity).setScreenTitle(getString(R.string.licence_template_title));
    ...
    private void loadCurrentTemplate() {
        ...
        Api.getClient().getBusinessTemplate(licenceId).enqueue(new Callback<AllApiResponse>() {
            @Override
            ...
            public void onFailure(@NonNull Call<AllApiResponse> call, @NonNull Throwable t) {
                binding.currentTemplateLabel.setText(getString(R.string.licence_template_load_failed));
            }
        });
    }
    ...
    private void runSave(TemplateChoice choice) {
        ...
        Api.getClient().setBusinessTemplate(licenceId, choice.businessType, choice.templateId, "",
