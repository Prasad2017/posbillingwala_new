...
import com.posbillingwala.admin.Utils.CatalogFileHelper;
...
public class MessMemberExcelFragment extends Fragment {
    ...
    private static final int PICK_XLSX = 5301;

    private Activity activity;
    private String customerId, licenceId, outletLabel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnTemplate.setOnClickListener(v -> download(
                "messMemberTemplate.php?userId=" + MainActivity.userId,
                "mess_member_template.xlsx"));
        btnExport.setOnClickListener(v -> download(
                "messMemberExport.php?userId=" + MainActivity.userId
                        + "&customerId=" + customerId + "&licenceId=" + licenceId,
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        try {
            File temp = copyUriToCache(data.getData());
            if (temp == null) {
            ...
            RequestBody customerBody = RequestBody.create(MediaType.parse("text/plain"), customerId);
            ...
            Api.getClient().messMemberImport(userBody, customerBody, licenceBody, part)
