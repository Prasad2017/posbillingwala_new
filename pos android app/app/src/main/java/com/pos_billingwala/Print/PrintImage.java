...
public class PrintImage {
    public final int bm_width;
    public final int bm_height;
    public final int[] pixels;
    public Bitmap bm_source;
    public Bitmap bm_print;
    ...
    public PrintImage(Bitmap _source) {
        ...
        if (width > 576) {
            ...
            //Check divided by 8
            if (Math.floor(width / 8) != (double) width / 8) {
        ...
        for (int y = 0; y < bm_height; y++) {
            for (int xbyte = 0; xbyte < bm_width / 8; xbyte++) {
                ...
                for (int bit = 0; bit < 8; bit++) {
                    ...
                    if (Pixel == 0xff000000) PrintByte = PrintByte | 1;
                }
