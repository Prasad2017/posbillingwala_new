...
public class OfflineNetworkData {
    ...
    public void saveProduct(String productId, String categoryId, String categoryName, String productCode, String productName, String productPrice, String productUnit, String productCGST, String productSGST, String productNetworkStatus, String productDeletedStatus, String subcategoryId, String openPrice, String productImage) {
        ...
        Call<AllApiResponse> call = Api.getClient(activity).saveProduct(MainActivity.ownerId, categoryId, categoryName, productCode, productName, productPrice, productUnit, productCGST, productSGST, productNetworkStatus, productDeletedStatus, subcategoryId, openPriceValue, imageValue);
        if (executeCall(call)) {
    ...
    public void saveCategory(String categoryId, String categoryName, String categoryDeletedStatus, String categoryNetworkStatus, String foodTypeCode, String categorySortOrder) {
        ...
        Call<AllApiResponse> call = Api.getClient(activity).saveCategory(MainActivity.ownerId, categoryName, categoryDeletedStatus, categoryNetworkStatus, foodTypeCode, categorySortOrder);
        if (executeCall(call)) {
    ...
    public void saveSubcategory(String subcategoryId, String categoryId, String categoryNetworkStatus, String subcategoryName, String subcategoryDeletedStatus, String subcategoryNetworkStatus, String subcategorySortOrder) {
        ...
        Call<AllApiResponse> call = Api.getClient(activity).saveSubcategory(MainActivity.ownerId, categoryId, categoryNetworkStatus, subcategoryName, subcategoryDeletedStatus, subcategoryNetworkStatus, subcategorySortOrder);
        if (executeCall(call)) {
