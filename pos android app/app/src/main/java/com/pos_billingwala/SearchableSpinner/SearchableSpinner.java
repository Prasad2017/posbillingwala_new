...
public class SearchableSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
    ...
    public SearchableSpinner(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            String fontFamily = a.getString(R.styleable.SearchableSpinner_fontFamily);
            if (fontFamily != null) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        // Apply the typeface to the hint or other text views as needed
        if (typeface != null) {
            // Set the typeface to the text views or hints
        }
    }
