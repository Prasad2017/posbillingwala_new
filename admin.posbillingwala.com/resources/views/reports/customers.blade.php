...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3 col-6"><div class="kpi-card kpi-blue"><span class="kpi-icon blue"><i class='bx bx-group'></i></span><span class="kpi-label">Total</span><span class="kpi-value">{{ number_format($data['totalCustomer']) }}</span></div></div>
            <div class="col-md-3 col-6"><div class="kpi-card kpi-green"><span class="kpi-icon green"><i class='bx bx-check-circle'></i></span><span class="kpi-label">Active</span><span class="kpi-value">{{ number_format($data['activeCustomer']) }}</span><span class="kpi-trend up">{{ $data['activePercent'] }}%</span></div></div>
