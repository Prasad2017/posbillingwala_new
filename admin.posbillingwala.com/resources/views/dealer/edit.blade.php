        ...
        ajax:"{{url('customers/all')}}?dealer_id={{$data->id}}",
            ...
            },
            {
                ...
                "mRender": function(data, type, row){
                    ...
                    actions += '<a href="{{url("customers/edit")}}/'+row.userId+'" class="btn btn-sm btn-primary btn-action-icon" title="Edit"><i class="bx bx-edit-alt"></i></a>';
                    if(row.licenseStatus=='expired'){
                        actions += '<a href="{{url("customers/delete")}}/'+row.userId+'" class="btn btn-sm btn-outline-success btn-action-icon" title="Activate"><i class="bx bx-check"></i></a>';
                    } else {
                        actions += '<a href="{{url("customers/delete")}}/'+row.userId+'" class="btn btn-sm btn-outline-danger btn-action-icon" title="Deactivate"><i class="bx bx-trash"></i></a>';
                    }
                    actions += '</div>';
                    return actions;
                },
