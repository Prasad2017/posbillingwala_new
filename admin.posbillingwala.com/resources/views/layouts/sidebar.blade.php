...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu pb-nav" id="menu">
        ...
        <li class="{{ $is(['settings/logo', 'settings/favicon', 'settings/pos-banners', 'settings/pos-splash', 'website']) ? 'mm-active' : '' }}">
            <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class='bx bx-slider-alt'></i></div>
                <div class="menu-title">App Settings</div>
            </a>
            <ul class="{{ $is(['settings/logo', 'settings/favicon', 'settings/pos-banners', 'settings/pos-splash', 'website']) ? 'mm-show mm-collapse' : 'mm-collapse' }}">
                ...
                <li class="{{ $navCurrent('settings/pos-splash') ? 'pb-nav-current' : '' }}">
                    <a href="{{ url('settings/pos-splash') }}"><i class="sub-icon bx bx-landscape"></i><span>Splash Upload</span></a>
                </li>
