...
function myTable()
{
    $("#myTable").dataTable({
        pbEmpty: {
            ...
            subtitle: 'Create categories to organize products in the catalog.',
            actionUrl: '{{ url("categories/add") }}',
        ...
        ajax:"{{url('categories/all')}}?customer_id="+($("#customerFilter").val() || ''),
            ...
            },
            {
                ...
                "mRender": function(data, type, row){
                    ...
                    actions += '<a href="{{url("categories/edit")}}/'+row.categoryId+'" class="btn btn-sm btn-primary btn-action-icon" title="Edit"><i class="bx bx-edit-alt"></i></a>';
                    actions += '<a href="{{url("subcategories/all")}}/'+row.userId+'/'+row.categoryId+'" class="btn btn-sm btn-outline-primary btn-action-icon" title="Subcategories"><i class="bx bx-list-ul"></i></a>';
                    actions += '<a href="{{url("categories/delete")}}/'+row.categoryId+'" class="btn btn-sm btn-outline-danger btn-action-icon" title="Toggle"><i class="bx bx-trash"></i></a>';
                    actions += '</div>';
                    return actions;
                },
