...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('website/settings', [\App\Http\Controllers\WebsiteCatalogController::class, 'companySettings']);
	Route::post('website/settings', [\App\Http\Controllers\WebsiteCatalogController::class, 'updateCompanySettings']);
	Route::get('website/dealers', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealers']);
	Route::get('website/dealers/add', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealerAdd']);
	Route::post('website/dealers/add', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealerStore']);
	Route::get('website/dealers/edit/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealerEdit']);
	Route::post('website/dealers/edit/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealerUpdate']);
	Route::get('website/dealers/toggle/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealerToggle']);
	Route::get('website/dealers/delete/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'dealerDelete']);
	Route::get('website/pricing', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricing']);
	Route::get('website/pricing/add', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricingAdd']);
	Route::post('website/pricing/add', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricingStore']);
	Route::get('website/pricing/edit/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricingEdit']);
	Route::post('website/pricing/edit/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricingUpdate']);
	Route::get('website/pricing/toggle/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricingToggle']);
	Route::get('website/pricing/delete/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'pricingDelete']);
	Route::get('website/products', [\App\Http\Controllers\WebsiteCatalogController::class, 'products']);
	Route::get('website/products/add', [\App\Http\Controllers\WebsiteCatalogController::class, 'productAdd']);
	Route::post('website/products/add', [\App\Http\Controllers\WebsiteCatalogController::class, 'productStore']);
	Route::get('website/products/edit/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'productEdit']);
	Route::post('website/products/edit/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'productUpdate']);
	Route::get('website/products/toggle/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'productToggle']);
	Route::get('website/products/delete/{id}', [\App\Http\Controllers\WebsiteCatalogController::class, 'productDelete']);
	Route::get('website/terms', [\App\Http\Controllers\WebsiteCatalogController::class, 'terms']);
	Route::post('website/terms', [\App\Http\Controllers\WebsiteCatalogController::class, 'updateTerms']);
	Route::get('website/refund', [\App\Http\Controllers\WebsiteCatalogController::class, 'refund']);
	Route::post('website/refund', [\App\Http\Controllers\WebsiteCatalogController::class, 'updateRefund']);
	Route::get('website/support', [\App\Http\Controllers\WebsiteCatalogController::class, 'supportPage']);
	Route::post('website/support', [\App\Http\Controllers\WebsiteCatalogController::class, 'updateSupportPage']);
	Route::get('website/company', [\App\Http\Controllers\WebsiteCatalogController::class, 'companyPage']);
	Route::post('website/company', [\App\Http\Controllers\WebsiteCatalogController::class, 'updateCompanyPage']);
});