<?php
/**
 * Admin auth wrapper around combo list for a customer shop userId.
 */
...
$response = array('status' => '1', 'comboResponse' => array());
...
admin_require_auth($con, array('status' => '0', 'comboResponse' => array()));
