			...
			$check = mysqli_fetch_array($res);
				if(isset($check))
				{
				    ...
				    if(isset($check1))
				    {
				       ...
				       $sql="UPDATE `products` SET `categoryId`='$categoryId', `productName`='$productName', `productPrice`='$productPrice', `productUnit`='$productUnit', 
                 ...
                 $sql="INSERT INTO `products`(`userId`, `categoryId`, `productName`, `productPrice`, `productUnit`, `productCGST`, `productSGST`, `productNetworkStatus`, `productStatus`) 
                       VALUES ('$customerId', '$categoryId', '$productName', '$productPrice', '$productUnit', '$productCGST', '$productSGST', '$productNetworkStatus', 'active')";
