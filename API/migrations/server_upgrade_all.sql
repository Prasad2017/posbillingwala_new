...
-- p26: dine-in / KOT — prefer API/migrations/p26_dine_in_kot.sql (or dine_in_ensure_schema())
-- Printer KOT settings
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'company_printer_setting' AND COLUMN_NAME = 'kotEnable') > 0, 'SELECT 1', 'ALTER TABLE `company_printer_setting` ADD COLUMN `kotEnable` VARCHAR(10) NULL DEFAULT ''on'''));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'company_printer_setting' AND COLUMN_NAME = 'kotPrefix') > 0, 'SELECT 1', 'ALTER TABLE `company_printer_setting` ADD COLUMN `kotPrefix` VARCHAR(32) NULL DEFAULT ''KOT-'''));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'company_printer_setting' AND COLUMN_NAME = 'kotCopies') > 0, 'SELECT 1', 'ALTER TABLE `company_printer_setting` ADD COLUMN `kotCopies` VARCHAR(8) NULL DEFAULT ''1'''));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'company_printer_setting' AND COLUMN_NAME = 'kotAutoPrint') > 0, 'SELECT 1', 'ALTER TABLE `company_printer_setting` ADD COLUMN `kotAutoPrint` VARCHAR(10) NULL DEFAULT ''off'''));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'company_printer_setting' AND COLUMN_NAME = 'kotPreview') > 0, 'SELECT 1', 'ALTER TABLE `company_printer_setting` ADD COLUMN `kotPreview` VARCHAR(10) NULL DEFAULT ''on'''));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'invoice' AND COLUMN_NAME = 'diningSessionId') > 0, 'SELECT 1', 'ALTER TABLE `invoice` ADD COLUMN `diningSessionId` VARCHAR(64) NULL DEFAULT NULL'));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'invoice' AND COLUMN_NAME = 'billPrintStatus') > 0, 'SELECT 1', 'ALTER TABLE `invoice` ADD COLUMN `billPrintStatus` VARCHAR(32) NULL DEFAULT NULL'));
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
