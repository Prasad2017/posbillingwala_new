...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE `products` SET `categoryId`='$categoryIdEsc', `productCode`='$productCodeEsc', `productName`='$productNameEsc',
            `productPrice`='$productPriceEsc', `productUnit`='$productUnitEsc', `productCGST`='$productCGSTEsc',
            `productSGST`='$productSGSTEsc'$subSql WHERE `productId`='$productIdEsc'";
