...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($check)) {
        ...
        if (isset($check1)) {
            ...
            $sql = "UPDATE `products` SET `categoryId`='$categoryId', `productCode`='$productCodeEsc', `productName`='$productNameEsc',
                    `productPrice`='$productPriceEsc', `productUnit`='$productUnitEsc', `productCGST`='$productCGSTEsc',
                    `productSGST`='$productSGSTEsc'$subSql WHERE `productId`='$productId'";
