...
CREATE TABLE `company_printer_setting` (
  ...
  `kotConnectionType` varchar(16) NOT NULL DEFAULT 'BLUETOOTH',
  `billUsbIdentifier` varchar(191) DEFAULT NULL,
  `billUsbName` varchar(128) DEFAULT NULL,
  `kotUsbIdentifier` varchar(191) DEFAULT NULL,
  `kotUsbName` varchar(128) DEFAULT NULL,
